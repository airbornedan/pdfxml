...
# Bounds measured from the supplied screen crop. The right and bottom values
# are exclusive, as required by PyMuPDF's clip rectangle.
ISOBUS_RECT = fitz.Rect(383, 16, 1537, 1064)
CORNER_RADIUS = 20
